...
return (
  ...
  return (
  <div className={className} style={{ position: "relative" }}> {/* changed: added position relative for legend anchoring */}
    {location.loaded && !location.error && (
      <>
        ...
        {/* changed: legend outside MapContainer but inside fragment so JSX is valid */}
{/* changed: legend updated to reflect pin style with SVG icons */}
<div style={{
