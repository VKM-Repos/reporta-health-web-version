                      ...
                      <div className="text-sm font-semibold px-5">
                        <div className="flex flex-col ">
                          <div className="flex gap-4 items-center -mb-8 ">
                            ...
                            <p className="text-primary font-extrabold text-xl font-sans w-full">
                              {" "}
                              {facility.reg_fac_name}
                            </p>
                          </div>
                          <div className="flex justify-center py-2 items-center text-primary gap-5">
                            <span className="text-sm flex justify-center items-center gap-1 font-sans font-semibold">
                            ...
                            <button className="border border-primary font-sans font-light text-xs text-black rounded-md py-1 px-3">
                              Reviews
                            </button>
                          </div>
                        </div>
                        ...
                        <div className="flex gap-5 py-2 divide-x divide-slate-300">
                          <div className="flex flex-col gap-1">
                            ...
                            <span className="text-sm font-sans lowercase w-48">
                              {facility.street_name
                                ? facility.street_name
                                : "N/A"}
                            </span>
                          </div>
                        ...
                        <div className="flex gap-5 py-2 divide-x divide-slate-300">
                          <div className="flex flex-col gap-1">
                            ...
                            <span className="text-sm font-sans w-48">
                        ...
                        <div className="flex justify-center gap-20 py-5">
                          <button
                            ...
                            className="text-danger font-sans font-light text-sm underline"
                          >
                            Report facility
                          </button>
                          <button className="bg-primary font-sans font-light text-sm px-6 py-2 rounded-md text-white">
                            Get Direction
                          </button>
                        </div>
