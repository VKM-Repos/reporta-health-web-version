...
const SearchQueryResult = (props) => {
  ...
  return (
    <section>
      ...
      <div className="flex items-center gap-7 px-4 py-4">
        <div>
          {
          indexOfFirstItem !== 0 ? <svg onClick={preveousPage} className="h-6 w-6 cursor-pointer" width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7.50003 14.5999L2.0667 9.16657C1.42503 8.5249 1.42503 7.4749 2.0667 6.83324L7.50003 1.3999" stroke="#242F9B" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
          : <svg className="h-6 w-6" width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M7.50003 14.5999L2.0667 9.16657C1.42503 8.5249 1.42503 7.4749 2.0667 6.83324L7.50003 1.3999" stroke="#808080" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
          }
        </div>
        <div>
         {
         indexOfLastItem < searchResultData?.length ? <svg onClick={nextPage} className=" cursor-pointer" width="30" height="30" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7.49997 3.4001L12.9333 8.83343C13.575 9.4751 13.575 10.5251 12.9333 11.1668L7.49997 16.6001" stroke="#242F9B" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
          : <svg className=" cursor-pointer" width="30" height="30" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M7.49997 3.4001L12.9333 8.83343C13.575 9.4751 13.575 10.5251 12.9333 11.1668L7.49997 16.6001" stroke="#808080" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
          }
        </div>
      </div>
