      ...
      <div className="flex items-center gap-7 px-4 py-4">
        <div>
          {indexOfFirstItem !== 0 ? (
            ...
            >
              <path
                d="M7.50003 14.5999L2.0667 9.16657C1.42503 8.5249 1.42503 7.4749 2.0667 6.83324L7.50003 1.3999"
                stroke="#242F9B"
                strokeWidth="1.5"
                strokeMiterlimit="10"
                strokeLinecap="round"
        ...
        <div>
          {indexOfLastItem < searchResultData?.length ? (
            <svg
              onClick={nextPage}
