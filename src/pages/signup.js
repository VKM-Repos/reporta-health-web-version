  ...
  return (
    <div className="max-w-screen max-h-screen flex">
      ...
      <div className="flex flex-col justify-center mx-auto">
        ...
        >
          <h2 className="text-3xl font-bold mt-10 lg:mt-2">Create account.</h2>
          <p className="text-secondary mt-3 mb-6">
            Enter a few details to create your account
          </p>
          <div className="grid grid-cols-2 gap-5 items-stretch">
            <div className="flex flex-col">
              <label htmlFor="firstName" className="mb-1 flex-col">
                First name
              </label>
              <Input
                type="text"
                ...
                className={
                  formik.touched.firstName && formik.errors.firstName
                    ? "p-3 bg-gray outline-none rounded-md border-danger leading-tight focus:outline-none focus:bg-white focus:border-danger animate-wiggle"
                    : "p-3 bg-gray outline-none rounded-md"
                }
                inputMode="FirstName"
                required
          ...
          <label htmlFor="phone" className="mt-5 mb-1">
            Phone number
          </label>
          <Input
            id="phone"
